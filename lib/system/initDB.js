...
function initDB(m, client) {
  ...
  settings.id ??= '120363422454443738@newsletter'
  settings.nameid ??= "「𝘼𝙡𝙖𝙨𝙩𝙤𝙧 𝙗𝙤𝙩 𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙤𝙛𝙘」ᥫ᭡"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api.yuki-wabot.my.id'
  settings.banner ??= 'https://cdn.apicausas.xyz/v/9f74eb61.jpg'
  settings.icon ??= 'https://cdn.apicausas.xyz/v/10ddd3c0.jpg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'Alastor'
  settings.botname ??= 'Alastor - MD'  
  settings.owner ??= ''
